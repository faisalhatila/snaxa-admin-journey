  ...
  return (
    <div className="col">
      <div className="row dataCounterRow">
        <div className="d-flex" style={{ minWidth: "100%" }}>
          ...
          <div className="col-6 col-lg col-md">
            <div className="counterRowDataCols">
              ...
              <p className="counterRowDataType totalCustomers">
                Total Customers
              </p>
            </div>
          </div>
        ...
        <div className="financialSheetViewButtonDiv d-flex justify-content-end">
          <Link to="/view-sales">
            <label className="financialSheetViewButton">
              View Financial Sheet
            </label>
          </Link>
        </div>
      </div>
